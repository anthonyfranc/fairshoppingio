      ...
      var e = {
                      ...
                      document.addEventListener('click', function (t) {
                        ...
                        if (o) {
                          var n = document.querySelectorAll(
                            o.getAttribute('data-hs-collapse')
                          );
                          e.toggle(n);
                        }
                      });
                    ...
                    value: function (e) {
                      ...
                      e.classList.add('open'),
                        ...
                        document
                          ...
                          .forEach(function (t) {
                            e.closest(t.getAttribute('data-hs-collapse')) &&
              ...
              return (
                ...
                (o = [
                    ...
                    value: function () {
                      ...
                      document.addEventListener('click', function (t) {
                        ...
                        if (
                          ...
                          if (
                            ('false' == i || 'inside' == i) &&
                            !n.parentElement.closest(e.selector)
                          )
                            return;
                        }
                        n &&
                          (n.classList.contains('open') ? e.close(n) : e.open(n));
                      }),
                        ...
                        document.addEventListener(
                          ...
                          function e(n) {
                            (n.target.closest(t.selector) &&
                              n.target.closest(t.selector) !==
                                o.parentElement.closest(t.selector)) ||
                              (t.close(o),
                      ...
                      if ('static' !== r) {
                        ...
                        var a = (0, n.fi)(e, t, {
                          ...
                          modifiers: [].concat(
                            s(
                              'fixed' !== r
                                ? this.absoluteStrategyModifiers(e)
                                : []
                            ),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = s(
                        e.querySelector('.hs-dropdown-menu').querySelectorAll('a')
                      ).filter(function (e) {
                        return !e.disabled;
                      });
                      t.length && t[0].focus();
                      ...
                      var o = this,
                        ...
                        r = function () {
                          return n.findIndex(function (e, n) {
                            return (
                              e.innerText.toLowerCase().charAt(0) ===
                                t.toLowerCase() && o._history.existsInHistory(n)
                            );
                          });
                        },
                        i = r();
                ...
                (o = [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this,
                        o = parseInt(
                          this.getClassProperty(e, '--auto-hide', '0')
                        );
                      o &&
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      try {
                        for (s.s(); !(t = s.n()).done; ) {
                          var c = t.value;
                          c.startsWith('hs-overlay-backdrop-open:') &&
                            (a += ' '.concat(c));
                        }
                      } catch (e) {
                        s.e(e);
                      ...
                      document.addEventListener('click', function (t) {
                        ...
                        if (o) {
                          var n = document.querySelector(
                            o.getAttribute('data-hs-remove-element')
                          );
                          n &&
            ...
            var c = (function (e) {
              ...
              function u() {
                ...
                return (
                  ...
                  ((e = l.call(this, '[data-hs-scrollspy] ')).activeSection =
                    null),
                  e
                );
              }
                      ...
                      document
                        ...
                        .forEach(function (t) {
                          var o = document.querySelector(
                              t.getAttribute('data-hs-scrollspy')
                            ),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = e.ev,
                        ...
                        r = e.$sectionEl,
                        i = parseInt(
                          this.getClassProperty(o, '--scrollspy-offset', '0')
                        ),
                        a = this.getClassProperty(r, '--scrollspy-offset') || i,
                        s =
                          t.target === document
                            ? 0
                            : parseInt(t.target.getBoundingClientRect().top),
                      ...
                      if (c <= 0 && c + l > 0) {
                        ...
                        var u = o.querySelector(
                          '[href="#'.concat(r.getAttribute('id'), '"]')
                        );
                        if (u) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = e.$scrollspyEl,
                        ...
                        i = parseInt(
                          this.getClassProperty(t, '--scrollspy-offset', '0')
                        ),
                        a = this.getClassProperty(r, '--scrollspy-offset') || i,
                ...
                (o = [
                    ...
                    value: function () {
                      ...
                      document.addEventListener(
                        ...
                        document
                          ...
                          .forEach(function (t) {
                            var o = document.querySelector(
                              t.getAttribute('hs-data-tab-select')
                            );
                            o &&
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (t) {
                        var o = r(t.querySelectorAll(this.selector)).filter(
                            function (e) {
                              return !e.disabled;
                            }
                          ),
                      ...
                      if (!e.classList.contains('show')) {
                        ...
                        (0, r.fi)(o, n, {
                          ...
                          e.addEventListener(
                            'mouseleave',
                            function o(n) {
                              (n.toElement.closest(t.selector) &&
                                n.toElement.closest(t.selector) == e) ||
                                (t.hide(e),
          ...
          714: (e, t, o) => {
            ...
            function _(e) {
              for (
                var t = n(e), o = x(e);
                o && S(o) && 'static' === h(o).position;
  
              )
                o = x(o);
              return o &&
                ('html' === p(o) ||
                  ('body' === p(o) && 'static' === h(o).position))
                ? t
                : o ||
                    (function (e) {
                      var t =
              ...
              if (f) {
                ...
                T === n(o) &&
                  ...
                  (i === E || ((i === P || i === j) && a === C)) &&
                    ((L = k),
                    (g -=
                      (y && A.visualViewport ? A.visualViewport.height : T[q]) -
                      r.height),
                    (g *= u ? 1 : -1)),
                  (i !== P && ((i !== E && i !== k) || a !== C)) ||
                    ((x = j),
                    (m -=
                      (y && A.visualViewport ? A.visualViewport.width : T[R]) -
                      r.width),
                    (m *= u ? 1 : -1));
              }
              var D,
                  ...
                  var n =
                      'clippingParents' === t
                        ? (function (e) {
                            var t = O(g(e)),
                              o =
                                ['absolute', 'fixed'].indexOf(h(e).position) >=
                                  0 && i(e)
                                  ? _(e)
                                  : e;
                            return r(o)
                    ...
                    if (A) {
                      if (i) {
                        var I,
                          ...
                          oe = ie(0, C[W], K[W]),
                          ne = S
                            ? C[W] / 2 - X - oe - ee - D.mainAxis
                            : Y - oe - ee - D.mainAxis,
                          ae = S
                            ? -C[W] / 2 + X + oe + te + D.mainAxis
                            : G + oe + te + D.mainAxis,
