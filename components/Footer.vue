<template>
  <div class="top-shadow border-t-[1px] border-slate-300 border-opacity-20">
    <footer
      class="
        bg-white
        dark:bg-gray-900
...
.top-shadow {
  ...
  box-shadow: 0 1px 2px 2px rgb(50 50 50 / 0.1), 0 1px 5px 4px rgb(50 50 50 / 0.1);
